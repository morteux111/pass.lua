...
titleText.Position = UDim2.new(0.5, -125, 0, 0)
titleText.BackgroundTransparency = 1
titleText.Text = "ValniX - Morteux"
...
minimizeBtn.BackgroundColor3 = Color3.fromRGB(35, 12, 12)
minimizeBtn.Text = "-"
minimizeBtn.TextColor3 = Color3.fromRGB(255, 90, 90)
minimizeBtn.TextSize = 17 * fontSizeScale
minimizeBtn.Font = Enum.Font.GothamBold
minimizeBtn.BorderSizePixel = 0
minimizeBtn.ZIndex = 10
minimizeBtn.Parent = panel
corner(minimizeBtn, 999)

-- NEW: Small Circular VM Button (Minimized State)
local vmIcon = Instance.new("TextButton")
vmIcon.Name = "VMIcon"
vmIcon.Size = UDim2.new(0, 60, 0, 60)
vmIcon.Position = UDim2.new(0.1, 0, 0.1, 0)
vmIcon.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
vmIcon.Text = "VM"
vmIcon.TextColor3 = Color3.fromRGB(255, 255, 255)
vmIcon.TextSize = 18
vmIcon.Font = Enum.Font.GothamBold
vmIcon.BorderSizePixel = 0
vmIcon.ZIndex = 100
vmIcon.Visible = false
vmIcon.Parent = screenGui
corner(vmIcon, 999)
stroke(vmIcon, Color3.fromRGB(60, 60, 75), 1.5)

-- Dragging logic for VM Button (Mobile & PC)
local vmDragging = false
local vmDragStart, vmStartPos

vmIcon.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        vmDragging = true
        vmDragStart = input.Position
        vmStartPos = vmIcon.Position
    end
end)
...
UserInputService.InputChanged:Connect(function(input)
    if vmDragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        local delta = input.Position - vmDragStart
        vmIcon.Position = UDim2.new(vmStartPos.X.Scale, vmStartPos.X.Offset + delta.X, vmStartPos.Y.Scale, vmStartPos.Y.Offset + delta.Y)
    end
end)
...
vmIcon.MouseButton1Click:Connect(showGui)
